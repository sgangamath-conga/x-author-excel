...
namespace Apttus.DynamicsCRM.LoginControl
{
    public partial class ApttusManageConnections : Form
    {
        ...
        private DynamicsCRMWebLogin DynamicsCRMOAuth;
        ...
        public ApttusManageConnections(DynamicsCRMWebLogin dynamicsCRMOAuth)
        {
            InitializeComponent();
            ...
            this.DynamicsCRMOAuth = dynamicsCRMOAuth;
            this.ApplicationSettings = dynamicsCRMOAuth.ApplicationSettings;
        }
        ...
        private void PopulateConnectionInfo()
        {
            ...
            foreach (KeyValuePair<string, SettingsManager.OAuthConnection> connection in connections)
            {
                ...
                btnConnect.Enabled = !DynamicsCRMOAuth.IsLoggedIn ? true : !(sConnectionName.Equals(sLastLogin));
                btnConnect.Tag = sHost;

                // Delete a connection
                Button btnDelete = new Button();
                btnDelete.Image = Properties.Resources.erase_16x16;
        ...
        void btnConnect_Click(object sender, EventArgs e)
        {
            ...
            {
                userName = userName.Substring(0, userName.LastIndexOf("_"));
                DynamicsCRMOAuth.ConnectionEndPoint = new Tuple<string, string>(userName, ((Button)sender).Tag as string);
        ...
        private void btnAuthorize_Click(object sender, EventArgs e)
        {
            if (ValidateConnection())
            {
                ...
                DynamicsCRMOAuth.ConnectionEndPoint = new Tuple<string, string>(txtName.Text, txtLoginURL.Text);
